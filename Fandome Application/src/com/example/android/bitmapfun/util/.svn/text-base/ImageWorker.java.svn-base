...
public abstract class ImageWorker {
     ...
     * disk cache will be used if an {@link ImagesCache} has been added using
     * {@link ImageWorker#addImageCache(FragmentManager, ImagesCache.ImageCacheParams)}. If the
    ...
    /**
     * @return The {@link ImagesCache} object currently being used by this ImageWorker.
     */
    protected ImagesCache getImageCache() {
        return mImageCache;
    }
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, BitmapDrawable> {
        private Object data;
        private final WeakReference<ImageViewWithProcessIndicator> imageViewReference;

        public BitmapWorkerTask(ImageViewWithProcessIndicator imageView) {
            imageViewReference = new WeakReference<ImageViewWithProcessIndicator>(imageView);
        }
        ...
        protected void onPostExecute(BitmapDrawable value) {
            ...
            final ImageViewWithProcessIndicator imageView = getAttachedImageView();
         ...
         */
        private ImageViewWithProcessIndicator getAttachedImageView() {
            final ImageViewWithProcessIndicator imageView = imageViewReference.get();
            final BitmapWorkerTask bitmapWorkerTask = getBitmapWorkerTask(imageView);
